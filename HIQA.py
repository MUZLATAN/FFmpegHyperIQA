...
class HyperNet(nn.Module):
    ...
    def __init__(self, lda_out_channels, hyper_in_channels, target_in_size, target_fc1_size, target_fc2_size, target_fc3_size, target_fc4_size, feature_size):
        ...
        self.res = self.resnet50_backbone(lda_out_channels, target_in_size, pretrained=True)
    ...
    def resnet50_backbone(self,lda_out_channels, in_chn, pretrained=False, **kwargs):
...
if __name__ == '__main__':
    hiqa = HIQA()
    print(hiqa.inference('./data/D_01.jpg'))
    pass